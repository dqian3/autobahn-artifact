...
class Ploter:
    ...
    def _plot(self, x_label, y_label, y_axis, z_axis, type, marker, color):
        ...
        plt.ylabel(y_label[0], fontweight='bold', fontsize=14)
    ...
    def plot_latency(self, system, faults, nodes, workers, tx_size):
        ...
        self.system = system
        z_axis = self._workers if scalability else self._nodes1
    ...
    def finalize(self, name, legend_cols, top_lim=None, legend_loc=None, legend_anchor=None):
        ...
        plt.legend(
            loc=legend_loc, bbox_to_anchor=legend_anchor, ncol=legend_cols, fontsize=14,
        )
        plt.xlim(xmin=0)
...
if __name__ == '__main__':
    ...
    all_systems = ['Autobahn', 'Bullshark', 'Batched-HS', 'Vanilla-HS']
    ...
    for system in all_systems:
        ploter.plot_latency(system, [0], [4], [1], 512)
    ploter.finalize(
        'committee-latency-visibility-arxiv',
        legend_cols=4,
        top_lim=2_500,
